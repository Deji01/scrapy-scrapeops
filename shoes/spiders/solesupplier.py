...
class SolesupplierSpider(scrapy.Spider):
    ...
    links = [
        f'https://thesolesupplier.co.uk/release-dates/?page={i}&q=dunk' for i in range(2, 44)]
    for link in links:
    ...
    def parse(self, response):
        ...
        next_page = response.css(
            "#main-content > div > div.advanced-listing-view > div.desktop-flex.advanced-listing-view__wrapper > section.advanced-listing-view__pagination > ul > li:nth-child(4) > a::attr(href)").get()
    ...
    def parse_item(self, response):
        for item in response.css("#main-content > div > div > article.product > div > div > section.product__trunk"):
            ...
            obj.add_css(
                "stock_status", "div.product__info > div.product__header-row > div > strong::text")
            obj.add_css(
                "price", "div.product__info > div.product__header-row > div > div > div.product__price > span > span::text")
            ...
            obj.add_css(
                "release_date", "article > div > div.product-footer > section > div:nth-child(1) > p > span::text")
            obj.add_css(
                "brand", "article > div > div.product-footer > section > div:nth-child(3) > p::text")
            obj.add_css(
                "model", "article > div > div.product-footer > section > div:nth-child(4) > p::text")
            obj.add_css(
                "style_code", "article > div > div.product-footer > section > div:nth-child(5) > p::text")
